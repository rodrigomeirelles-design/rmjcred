      ...
      <div className={`${styles.container} container grid grid-4`}>
        ...
        <div className={styles.colInfo}>
          ...
          <p className={styles.description}>
            Com mais de 20 anos de experiência no mercado de crédito, a RMJ oferece expertise e atendimento estratégico para impulsionar negócios e viabilizar conquistas. Somos o seu hub completo de soluções financeiras.
          </p>
          <div className={styles.socialList}>
            ...
            <a href="https://wa.me/5535991084513" target="_blank" rel="noopener noreferrer" className={styles.socialLink} aria-label="WhatsApp">
              <svg viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
